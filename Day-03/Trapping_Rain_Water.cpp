...
- Sum up the trapped water across all indices.
...
left and right. Precomputing these values allows us to calculate the trapped
water efficiently in linear time.
